...
#llm
writer_llm= ChatMistralAI(model_name= "mistral-medium-3-5", temperature= 0.7)
writer_llm_with_tools= writer_llm.bind_tools(tools= tools)

reviewer_llm= ChatGroq(model_name= "openai/gpt-oss-120b",temperature= 0.7)
reviewer_llm_with_tools= reviewer_llm.bind_tools(tools= tools)
